...
add_btn.addEventListener('click', (event) => {
    list_wrap.innerHTML +=
        `<div class="bg-orange-500 h-[200px] border border-black p-4">
            <h1 class="text-blue-300">`+ text_input.value + `</h1>    
            <p font-md>Item can be found somewhere is this world</p>
            <button onclick="deleteHandler(this)" class="mt-10 border rounded-xl bg-white md:hover:bg-gray-300 md:duration:200 px-2" id="del-`+ id + `">Delete</button>
        </div>`;
